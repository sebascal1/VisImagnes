...
def setup_journal():
    ...
    gen.download_file_from_google_drive(train_set_1, "data_tresh.zip", size=216e3)
    gen.download_file_from_google_drive(train_set_2, "data_segment.zip", size=55.7e3)
    gen.download_file_from_google_drive(train_set_2, "data_original.zip", size=549.7e3)
